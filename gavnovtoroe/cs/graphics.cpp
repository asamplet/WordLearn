...
void Learn_enru()
{
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (count != 30) {
                if (event.type == Event::KeyPressed
                    && event.key.code == Keyboard::Enter && rus == st) {
                    st.clear();
                    count++;
...
void Learn_ruen()
{
    ...
    while (window.isOpen()) {
        ...
        while (window.pollEvent(event)) {
            ...
            if (count != 30) {
                if (event.type == Event::KeyPressed
                    && event.key.code == Keyboard::Enter && eng == st) {
                    st.clear();
                    count++;
                    eng = (const char*)w[count].en;
                    rus = (const char*)w[count].ru;
